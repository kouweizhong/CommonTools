...
namespace CommonTools.Common
{
    public static class PublicFunc
    {
        ...
        /// Author  : 俞立钢
        /// Company : 绍兴标点电子技术有限公司
        /// Created : 2014-12-12 14:30:34
        private static Dictionary<String, ImageFormat> GetImageFormats()
        {
            Dictionary<String, ImageFormat> dic = new Dictionary<String, ImageFormat>();
            ...
            foreach (var property in properties)
            {
                ...
                name = property.Name;
                if (name.Equals("jpeg", StringComparison.CurrentCultureIgnoreCase))
                {
                    name = "jpg";
                }
                dic.Add(("." + name).ToLower(), format);
            }
            return dic;
        }
        ...
        /// <param name="imageFormats">The image formats.</param>
        /// <returns>String.</returns>
        /// Author  : 俞立钢
        /// Company : 绍兴标点电子技术有限公司
        /// Created : 2014-12-12 14:35:39
        public static String GetExtension(this Image image, Dictionary<String, ImageFormat> imageFormats)
        {
