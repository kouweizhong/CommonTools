...
namespace CommonTools.Win
{
    public partial class StartForm : BaseForm
    {
        ...
        {
            //SetPicBoxColor(null, PicEncrypte);
        }
        ...
        private void SetPicBoxColor(Color color, PictureBox pictureBox)
        {
            ...
            g.DrawRectangle(pen, pictureBox.ClientRectangle.X, pictureBox.ClientRectangle.Y, pictureBox.ClientRectangle.X + pictureBox.ClientRectangle.Width-1, pictureBox.ClientRectangle.Y + pictureBox.ClientRectangle.Height-1);
        }
