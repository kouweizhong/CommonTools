...
namespace CommonTools.Win
{
    public partial class StartForm : BaseForm
    {
        ...
        {
            PicEncrypte.BackColor = Color.SteelBlue;
            PicEncrypte.Refresh();
        }
        ...
        private void ClearPicBoxColor(PictureBox pictureBox)
        {
            pictureBox.BackColor = Color.Transparent;
            pictureBox.Refresh();
        }

        private void SetBackColor(Color color, PictureBox pictureBox)
        {
