...
namespace CommonTools.Win.Encrypte
{
    public partial class EncrypteForm : BaseForm
    {
        ...
        private void EncrypteForm_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                labelControl2.Visible = labelControl3.Visible = labelControl5.Visible = labelControl6.Visible = labelControl7.Visible = TxtNumber.Visible = TxtCiphertext1.Visible = TxtCiphertext2.Visible = true;
            }
        }
